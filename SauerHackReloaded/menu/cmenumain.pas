...
uses
  ...
  cmenuwindow, ccontroldrawer, CustomTypes, DrawText;
...
type
  ...
  public
    ...
    MouseX:Single;
    MouseY:Single;
    CheckBoxes:array [0..3] of TCheckbox;
    CheckBoxStrings:array [0..3] of String;
...
var Dragging:Pointer=Pointer($10508);
    MouseXOri:Pointer=Pointer($1050C);
    MouseYOri:Pointer=Pointer($10510);
    MReleaser:PByte=PByte($103F0);
...
begin
  ...
  PMouseX := Pointer(GetModuleHandle('sauerbraten.exe') + $1E49CC);
  PMouseY := Pointer(GetModuleHandle('sauerbraten.exe') + $1E49C8);
